...
def draw_heatmap(correlation_matrix,name,data_name,width=8,height=6,TITLE_SIZE=30
                   ,XLABEL_SIZE=25,YLABEL_SIZE=25,LEGEND_SIZE=16,XTICK_SIZE=30,YTICK_SIZE=30,STEPSIZE=5,CBAR=True):
    ...
    sns.heatmap(correlation_matrix, ax=ax,annot=False, cmap='coolwarm', fmt='.2f',cbar=CBAR)
    ...
    #ax.set_title(f'Correlation Heatmap between Layers of {data_name}')
    if CBAR:
