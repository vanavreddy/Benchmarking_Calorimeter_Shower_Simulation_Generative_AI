...
def draw_plots(correlations,g_idx,name,model_names,plot,out_dir,mode):
    frobs=[]
    re_models=[]
    ...
    if plot=='heatmap':
        ...
        for i,corr in enumerate(correlations):
            file_name=model_names[i]+'_'+name
            if mode=='voxel':
...
def main(evaluate_path, dataset,out_dir,mode,plot):
    ...
    if mode=='voxel':
        ...
        fileName=plot+'_'+dataset+'_'+mode+'.pdf'
        draw_plots(correlations,g_idx,fileName,model_names,plot,out_dir,mode)
