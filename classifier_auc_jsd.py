...
""" Main script to evaluate contributions to the Fast Calorimeter Challenge 2022
    ...
    input:
        - set of events in .hdf5/.h5 file format (same shape as training data)
    output:
    ...
    usage:
        ...
        -b --binning_file: Path to the XML binning file corresponding to the dataset
